        ...
        <div className="main-container">
            <div className="content-container">
                ...
                <h1>
                    ...
                    <br />
                    Tu editor de planes de estudio
                    <br />
                    🎓
                </h1>
                ...
                <p className="text-lg leading-relaxed">
                    Organiza, personaliza y da seguimiento al plan de estudio de tu carrera. Este es tu espacio para
                    gestionar todas tus materias y planificar tu futuro
                </p>
                ...
                <ul className="mt-6 space-y-3 list-disc list-inside text-gray-700 dark:text-gray-300">
                    ...
                    <li>
                        <span className="font-semibold">Crea</span> planes de estudio personalizados adaptados a tus
                        necesidades
                    </li>
                </ul>
            ...
            >
              Ver en Plantillas
                    ...
                    <div className="card">
                        ...
                        <a href="https://forms.gle/Hve3WEhUxm81Cqr59" target="_blank" className="card-btn">
                            Ir al Formulario
                        </a>
                    </div>
                </div>
